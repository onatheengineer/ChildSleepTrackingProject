...
import { secretsPROJECT } from './secretsPROJECT.ts'

const getDBConnectionPROJECT = async (): Promise<Connection> => {
  try {
    const secretString = await secretsPROJECT()
